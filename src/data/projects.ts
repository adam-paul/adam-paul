...
const projects: Project[] = [
  {
    ...
    images: [
      { type: 'video', url: 'https://i.imgur.com/YSuq7Wg.mp4' },
      { type: 'image', url: 'https://i.imgur.com/MjUHgDV.png' },
      { type: 'image', url: 'https://i.imgur.com/LNKSqGa.png' },
    ],
  ...
  },
  {
    ...
    images: [
      { type: 'image', url: 'https://i.imgur.com/Zxx8r5Q.png' },
      { type: 'image', url: 'https://i.imgur.com/r44s8je.png' },
      { type: 'image', url: 'https://i.imgur.com/qvvuCy0.png' },
    ],
  ...
  },
  {
    ...
    images: [
      { type: 'image', url: 'https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=2070&auto=format&fit=crop' },
      { type: 'image', url: 'https://images.unsplash.com/photo-1585503418537-88331351ad99?q=80&w=2074&auto=format&fit=crop' },
      { type: 'image', url: 'https://images.unsplash.com/photo-1593642702821-c8da6771f0c6?q=80&w=1932&auto=format&fit=crop' }
    ],
  ...
  },
  {
    ...
    images: [
      { type: 'image', url: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=1965&auto=format&fit=crop' },
      { type: 'image', url: 'https://images.unsplash.com/photo-1668088233308-0cf1a9b5ba4c?q=80&w=2070&auto=format&fit=crop' },
      { type: 'image', url: 'https://images.unsplash.com/photo-1655721530791-59f5bbd64a36?q=80&w=1932&auto=format&fit=crop' }
    ],
  ...
  },
  {
    ...
    images: [
      { type: 'image', url: 'https://images.unsplash.com/photo-1639762681057-408e52192e55?q=80&w=2032&auto=format&fit=crop' },
      { type: 'image', url: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=1974&auto=format&fit=crop' },
      { type: 'image', url: 'https://images.unsplash.com/photo-1642058800587-6a231f468e3e?q=80&w=1972&auto=format&fit=crop' }
    ],
